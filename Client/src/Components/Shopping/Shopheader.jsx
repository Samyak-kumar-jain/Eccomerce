...
const Shopheader = () => {
  ...
  const menuItems = [
    ...
    { to: "/shop/listing", label: "Men", id: "men" },
    { to: "/shop/listing", label: "FootWear", id: "footwear" },
    { to: "/shop/listing", label: "Kids", id: "kids" },
    { to: "/shop/listing", label: "Women", id: "women" },
    { to: "/shop/listing", label: "Accessories", id: "accessories" },
  ];
      ...
      <div className='sticky top-0 z-50 w-full bg-background border-b'>
        <div className='flex h-16 items-center justify-between px-4 md:px-5'>
          <Link to="/shop/home" className='flex items-center gap-2 justify-center'>
            ...
            <span className='font-bold'>Zody</span>
          </Link>
