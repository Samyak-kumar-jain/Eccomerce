...
const ImageUpload = ({ isEditMode, imageFile, setImageFile, uploadImgUrl, setImgUploadUrl, setImageLoadingState, imagLoadingState }) => {
    ...
    const uploadImageToCloudinary = async () => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/admin/products/upload-image`, {
                method: 'POST',
                body: data,
            });
    ...
    return (
        <div>
            <label className='block mb-3 text-teal-400'>Upload Image</label>
            <div
                className='border-2 border-dashed border-gray-500  rounded-lg p-4 bg-gray-800'
